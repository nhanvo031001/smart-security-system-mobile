...
import VideoViewLineCrossing from "../VideoViewLineCrossing";

export default function MonitorVideoLineCrossing({ navigation }) {
        ...
        <ScrollView style={styles.monitorVideoContainer}>
            ...
            {videosList && videosList.map((video, idx) => {
                return <View key={idx} style={styles.videoBlock}>
                    ...
                    <VideoViewLineCrossing video_url={video.video_url} />
